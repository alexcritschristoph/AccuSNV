...
Along with its SNV tables and tree, AccuSNV produces an interactive HTML dashboard for inspecting SNVs, the reasons why SNV sites were filtered, and their positions in the tree. <a href="group_L01_snv_dashboard.html" target="_blank">Here is an example file from the tutorial</a>.
